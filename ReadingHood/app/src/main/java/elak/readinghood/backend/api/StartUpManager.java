...
public class StartUpManager {
    ...
    /**
     * This function assembles the set of the variables for the registration process. It uses the functions:
     ...
     * @return the error text
     */
    public String registrationSet(int panelID, String email, String username, String department, String password, String rePassword) {
        if (panelID == 1) {
