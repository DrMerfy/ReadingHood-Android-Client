            ...
            try {
                ...
                for (int i = 0; i < jsonThreads.length(); i++) {
                    try {
                        ...
                        System.out.println("id = " + id + " , title = " + title + " , views = " + views);

                        //getting tags
                        ArrayList<Tag> tags = new ArrayList<>();
                        System.out.println("Tags of this thread : ");
                        try {
                            ...
                            for (int j = 0; j < tagsArray.length(); j++) {
                                ...
                                try {
                                    ...
                                    System.out.println(tags.get(j).getName() + " , " + tags.get(j).getId() + " , " + tags.get(j).getUsages() );
                                } catch (JSONException J) {
                        ...
                        System.out.println("Posts of this thread : ");
                        try {
